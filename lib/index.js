          ...
          <View style={ Styles.contenedor }>
            <View style={ Styles.contenidoPropmt }>
              <View style={ Styles.contenedorTitulo }>
                <Text style={ Styles.titulo }>{ this.props.title ? this.props.title : 'Titulo'  }</Text>
              </View>
              ...
              <View>
                ...
                <View style={ Styles.botones }>
                  <TouchableOpacity onPress={ () => { this.props.onCancel('Cancel') }} style={ Styles.cancelAceptar }>
                    <Text style={ Styles.textButon }>{ this.props.textCancel ? `${this.props.textCancel}` : 'Cancel' }</Text>
                  </TouchableOpacity>
                  <TouchableOpacity onPress={ () => this.props.onAccept(this.state.valor) } style={ Styles.cancelAceptar }>
